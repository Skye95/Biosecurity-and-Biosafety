        ...
        <div class="row">
            ...
            <div class="col-md-10">
               <?php echo form_open('pc2/index'); ?>
                       ...
                       <tbody>
                           <tr>
                               <td colspan="2">
                                   <table class="table table-bordered">
                                       <tr>
                                           <td width="80">Title: <input type="text" class="form-control" name="project_add_title[0]" value="<?php if(isset($load)){echo set_value('project_add_title[0]', $a[0]);}else{echo set_value('project_add_title[0]');} ?>"></td>
                   ...
                   <table class="table table-bordered">
                       <tr>
                                           <td width="80">Title: <input type="text" class="form-control" name="project_add_title[1]" value="<?php if(isset($load)){echo set_value('project_add_title[1]', $a[1]);}else{echo set_value('project_add_title[1]');} ?>"></td>
                ...
                <span class="text-danger"><?php echo form_error('project_facilities_certification_no'); ?></span>
                   ...
                   <div>
                       ...
                       <a class="btn btn-primary" href="<?php echo base_url(); ?>index.php/pc2/load_form">Load</a>
                   </div>
