...
<body>
    ...
    <script>
        function approve(i){
            window.location = "<?php echo base_url(); ?>index.php/exempt_approval/approve/" + i;
        }
        
        function reject(i){
            var j = prompt("Reason for Rejecting:", "Does not meet requirements");
            if (j != null) {
                window.location = "<?php echo base_url(); ?>index.php/exempt_approval/reject/" + i + "/" + btoa(j);
            }
        }
    </script>
    ...
    <script>
        function approve2(i){
            window.location = "<?php echo base_url(); ?>index.php/exempt_approval/approve2/" + i;
        }
        
        function reject2(i){
            var j = prompt("Reason for Rejecting:", "Does not meet requirements");
            if (j != null) {
                window.location = "<?php echo base_url(); ?>index.php/exempt_approval/reject2/" + i + "/" + btoa(j);
            }
        }
    </script>
    ...
    <script>
        function approve_hirarc(i){
            window.location = "<?php echo base_url(); ?>index.php/exempt_approval/approve_hirarc/" + i;
        }
        
        function reject_hirarc(i){
            var j = prompt("Reason for Rejecting:", "Does not meet requirements");
            if (j != null) {
                window.location = "<?php echo base_url(); ?>index.php/exempt_approval/reject_hirarc/" + i + "/" + btoa(j);
            }
        }
    </script>
    ...
    <script>
        function approve_hirarc2(i){
            window.location = "<?php echo base_url(); ?>index.php/exempt_approval/approve_hirarc2/" + i;
        }
        
        function reject_hirarc2(i){
            var j = prompt("Reason for Rejecting:", "Does not meet requirements");
            if (j != null) {
                window.location = "<?php echo base_url(); ?>index.php/exempt_approval/reject_hirarc2/" + i + "/" + btoa(j);
            }
        }
    </script>
    <!-- END of HIRARC -->
    ...
    <script>
        function approve_swp(i){
            window.location = "<?php echo base_url(); ?>index.php/exempt_approval/approve_swp/" + i;
        }
        
        function reject_swp(i){
            var j = prompt("Reason for Rejecting:", "Does not meet requirements");
            if (j != null) {
                window.location = "<?php echo base_url(); ?>index.php/exempt_approval/reject_swp/" + i + "/" + btoa(j);
            }
        }
    </script>
    ...
    <script>
        function approve_swp_2(i){
            window.location = "<?php echo base_url(); ?>index.php/exempt_approval/approve_swp_2/" + i;
        }
        
        function reject_swp_2(i){
            var j = prompt("Reason for Rejecting:", "Does not meet requirements");
            if (j != null) {
                window.location = "<?php echo base_url(); ?>index.php/exempt_approval/reject_swp_2/" + i + "/" + btoa(j);
            }
        }
    </script>
    <!-- END of SWP -->
