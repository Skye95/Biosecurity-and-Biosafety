                   ...
                   <div class="row">
                       <div class="col-md-6 grey">
                           <p><strong>IBC Use Only</strong></p>
                            ...
                            <div class="checkbox">
                              <label><input type="checkbox" name="IBC_approval" value="1" <?php echo set_checkbox('IBC_approval', '1'); ?> <?php if(isset($load)){if($item->request_type==1){echo "checked=checked";}}else{} ?>>Use /Possession Approved</label>
                            </div>
                            <div class="checkbox">
                              <label><input type="checkbox" name="IBC_approval" value="0" <?php echo set_checkbox('IBC_approval', '0'); ?> <?php if(isset($load)){if($item->request_type==0){echo "checked=checked";}}else{} ?>>Use/Possession Disapproved</label>
                            </div>
                            <div class="checkbox">
                              <label><input type="checkbox" name="IBC_termination" value="1" <?php echo set_checkbox('IBC_termination', '1'); ?> <?php if(isset($load)){if($item->request_type==1){echo "checked=checked";}}else{} ?> >Termination Approved</label>
                            </div> 
                       </div>
                   </div>
                   <hr>
