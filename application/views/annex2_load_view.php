    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-10">
                ...
                <?php echo form_open('annex2.2/index'); ?>
                   ...
                   <div>
                       ...
                       <div class="form-group">
                           Period of contained use activity/field experiment: <input type="text" class="form-control" name="period" value="<?php echo set_value('period', $item->period); ?>" >
                   ...
                   <div>
                       ...
                       <a name="load" class="btn btn-primary" href="<?php echo base_url(); ?>index.php/annex2/fill_annex2">Load</a>
                   </div>
