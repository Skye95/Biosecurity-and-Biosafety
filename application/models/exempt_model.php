...
class exempt_model extends CI_Model
{
    ...
    {
        $this->db->select('*');
        $this->db->from('exemptdealing');
        $this->db->join('accounts', 'exemptdealing.account_id = accounts.account_id');
        $this->db->where('exemptdealing.editable', 1);
        $query = $this->db->get();
		return $query->result();
    }
    ...
    function get_all_form() 
    {
        ...
        $this->db->from('exemptdealing');
        $this->db->join('accounts', 'exemptdealing.account_id = accounts.account_id');
        $this->db->where('exemptdealing.application_approved IS NULL', null, false);
        $query = $this->db->get();
		return $query->result();
    }
    ...
    function get_all_form2() 
    {
        ...
        $this->db->from('exemptdealing');
        $this->db->join('accounts', 'exemptdealing.account_id = accounts.account_id');
        $this->db->where('exemptdealing.application_approved', 1);
        $this->db->or_where('exemptdealing.application_approved', 3);
        $query = $this->db->get();
		return $query->result();
    }
    ...
    function get_all_form3() 
    {
        ...
        $this->db->from('exemptdealing');
        $this->db->join('accounts', 'exemptdealing.account_id = accounts.account_id');
        $this->db->where('exemptdealing.application_approved', 2);
        $query = $this->db->get();
		return $query->result();
    }
	...
	function get_form_by_id($id)
	{
        ...
        $query = $this->db->get('exemptdealing');
		return $query->result();
	}
