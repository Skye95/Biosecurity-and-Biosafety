...
class notification_of_LMO_and_BM_approval extends CI_Controller {
    ...
    public function approve($id, $appID)
    {
        ...
        $this->email_model->send_email($result[0]->account_email, "Dear ". $result[0]->account_fullname .", Notification of LMO and Biohazardous Materials Form Submission Approved", "<p>Your Notification of LMO and Biohazardous Materials Form Has Been Approved. </p>");
    ...
    public function reject($id, $appID)
    {
        ...
        $this->email_model->send_email($result[0]->account_email, "Dear ". $result[0]->account_fullname .", Notification of LMO and Biohazardous Materials Form Submission Rejected", "<p>Your Notification of LMO and Biohazardous Materials Form Has Been Rejected Due to The Following Reason(s): " . $msg . "</p>");
