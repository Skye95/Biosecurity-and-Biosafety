...
class exempt_approval extends CI_Controller {
	...
	public function index()
	{
        ...
        $data['all_exempt_SSBC'] = $this->exempt_model->get_all_form2();
    
        $data['all_hirarc'] = $this->hirarc_model->get_all_hirarc2_form();
        $data['all_hirarc_SSBC'] = $this->hirarc_model->get_all_hirarc2_form2();
        
        $data['all_swp'] = $this->swp_model->get_all_swp2_form();
        $data['all_swp_SSBC'] = $this->swp_model->get_all_swp2_form2();
    ...
    public function approve($id)
    {
        ...
        $this->exempt_model->update_approval($id, 1, $approver_id);
    ...
    public function reject($id)
    {
        ...
        $this->exempt_model->update_approval($id, 0, $approver_id);
    ...
    public function approve2($id)
    {
        $approver_id = $this->session->userdata('account_id');
        $id = $this->uri->segment(3);
        $this->exempt_model->update_approval_SSBC($id, 1, $approver_id);
    ...
    public function reject2($id)
    {
        ...
        $id = $this->uri->segment(3);
        $msg = base64_decode($this->uri->segment(4));
        $this->exempt_model->update_approval_SSBC($id, 0, $approver_id);
