	...
	public function index()
	{
        ...
        if($this->form_validation->run() == FALSE){
            ...
            if($this->account_model->insert_new_account($data)){
                ...
                $this->email_model->send_email($this->input->post('account_email'), "New Registration Request", "<p>Dear ". $this->input->post('account_fullname') .", <br/><br/>You have successfully requested for an account. Please wait between 1-3 working days before logging in again.</p>");
